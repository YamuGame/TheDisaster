...
public class Story {
    ...
    public static void stage1After() {
        ...
        System.out.println(""
                ...
                + "どちら進む、貴様の『決意』にゆだねる。▼");
        scan.nextLine();
        System.out.println("1.「ステージ2」に進む , 2. 「選択2」に進む");
    }
    ...
    public static void epilogue() {
        ...
        System.out.println(""
                + "最初の方は上手くいっていた。\n"
                + "かつて貴様と同一存在だった時の名前を捨て▼");
        scan.nextLine();
        System.out.println(""
                + "新たに『Star Dies』と名前も付けられた。\n"
                + "目標である世界の混沌を超えた▼");
        scan.nextLine();
        System.out.println(""
                + "星の死という意味の素晴らしい名前だ。\n"
                + "しかし私のことが知られるたびに私を知った者が死んでいってしまう。▼");
        scan.nextLine();
        System.out.println(""
                + "ある者は私を倒そうと、\n"
                + "ある者は私に殺されるなら自らの手で…▼");
        ...
        System.out.println(""
                + "と私を知るものが次々消えていってしまう。\n"
                + "まるで私に付けられた名前を遂行するかのように…▼");
        scan.nextLine();
        System.out.println(""
                + "ウイルスだって感染者が他人に感染させる前に\n"
                + "死んでしまっては次の存在を残せない。▼");
        scan.nextLine();
        System.out.println(""
        ...
        System.out.println(""
                ...
                + "こう貴様に対してメッセージを書いているうちに思い出したのだが▼");
        scan.nextLine();
        System.out.println(""
                + "あのダンジョンにはおもちゃのナイフや\n"
                + "魔法のフライパンなどの武器とは思えないものもあった。▼");
        scan.nextLine();
        System.out.println(""
                + "もしやり直せるなら彼らを傷つけないようにそういう\n"
                + "武器に変えて彼らを死なせないようにできないだろうか….▼");
        scan.nextLine();
        System.out.println(""
                + "\n"
                + "(メッセージは以上です。)▼");
    ...
    public static void specialVictory() {
        System.out.println("特殊勝利ステージ");
        System.out.println(""
                + "それが貴様の選択か…ならば受け入れよう。\n"
                + "それが" + DisasterName + "としての決断だ…。▼");
        scan.nextLine();
        System.out.println(""
                + "グリムゲルデ「なんてことをしてくれたんだ。\n"
                + "人間にも倒されず、");
        scan.nextLine();
        System.out.println(""
                + "封印もされず、\n"
                + "私にも倒されない災害なんて語り継がれないじゃないか…。");
        scan.nextLine();
        System.out.println(""
                + "自害する災害なんてありえない。\n"
                + "" + DisasterName + "は絶対悪として語り継がねばならないのに…。");
        scan.nextLine();
        System.out.println(""
                + "ヴァルハラに送るには絶対悪と対峙した者でなければらない。\n"
                + "これでは死んでいった兵が正義か悪かわからなくなってしまう。");
        scan.nextLine();
        System.out.println(""
                + "奴をダンジョンで封印するという行為が無駄じゃないか…。\n"
                + "誰の入れ知恵だ…?");
        scan.nextLine();
        System.out.println(""
                + "まさかこのダンジョンに発生した新たな災害がいるというのか…?\n"
                + "神話にすら載っていない災害なんてどう対処すれば…。");
        scan.nextLine();
        System.out.println(""
                + "私を欺くなんて、許せない、\n"
                + "私に倒されろ！");
